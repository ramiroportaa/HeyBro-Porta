            ...
            <div className="row align-items-center">
              <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
                ...
                <ul className="list-unstyled mb-0">
                  ...
                  <li key="shop">
                    <Link to="/productos?page=1" className="text-white">E-SHOP</Link>
                  </li>
                  <li key="contacto">
              ...
              <div className="col-lg-4 col-md-12 mb-4 mb-md-0">
                <iframe title="maps" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3400.889891852303!2d-68.58001668447072!3d-31.527183981367404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9681410672252731%3A0x76bd74a1f3918381!2sHey%20Bro*21%20Outfits!5e0!3m2!1ses!2sar!4v1632608056506!5m2!1ses!2sar" width="300rem" height="220rem" loading="lazy"></iframe>
              </div>
            </div>
          </section>
        </div>
